...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get("/api/track/:trackingNumber", async (req: Request, res: Response) => {
    try {
      ...
      // If database fails or order not found, check mock data
      const mockOrders = [
        {
          id: "1",
      ...
      const mockTrackingHistory = new Map<string, any[]>();
      
      // Add tracking data for order 1
      mockTrackingHistory.set("1", [
        {
          id: "1-1",
          orderId: "1",
      ...
      // Add tracking data for order 2
      mockTrackingHistory.set("2", [
        {
          id: "2-1",
          orderId: "2",
          status: "Package received",
      ...
      // Add tracking data for order 3
      mockTrackingHistory.set("3", [
        {
          id: "3-1",
          orderId: "3",
          status: "Package received",
      ...
      return res.json({
        order: mockOrder,
        trackingHistory: mockTrackingHistory.get(mockOrder.id) || []
      });
