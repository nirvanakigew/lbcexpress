  ...
  (function ($) {
      ...
      $.fn.rsearchit = function (options){

          return this.each(function () {

              $.fn.rsearchit.globals = $.fn.rsearchit.globals || {
                  counter: 0
              }
              $.fn.rsearchit.globals.counter++;
              var $counter = $.fn.rsearchit.globals.counter;

              var $t = $(this);
              var opts = $.extend({}, $.fn.rsearchit.defaults, options);

              // Setup default text field and class
     if (opts.textField == null) {
                  $t.before("<input  class='ratesorde'  placeholder='Choose City / Town' type='textbox' id='__searchit" + $counter + "'><br>");
...
$("#tothephil2").rsearchit({
      textFieldClass: 'newsearch-rates',
      selected: true
  });

$("#fromthephil1").rsearchit({
      textFieldClass: 'newsearch-rates',
      selected: true
  });
